...
- ใช้ใน [[Web-Exploitation|Web]] **เกือบทุกโจทย์**
...
### 10. sqlmap
- automated SQL injection — ใช้ตอนหลัง [[SQL-Injection]] ที่ทำมือเสร็จ
```bash
...
> 💡 **เคล็ดลับ**: ใช้ Obsidian (vault นี้!) จดโน้ตขณะแข่ง — กดเชื่อม `[[link]]` ไปดู cheatsheet ได้เร็ว
...
- เซ็ตเสร็จแล้วไปเรียน [[Methodology|วิธีคิด/ขั้นตอนแก้โจทย์]]
- หรือกระโดดไปหมวดที่อยากฝึก: [[03-Web-Exploitation/SQL-Injection|Web]] / [[04-Cryptography/Classical-Ciphers|Crypto]]
