...
- After IEND chunk — ignored by viewer แต่ data ยังอยู่ (use [append-after-EOF](Stego-Intro.md))
...
### PNG height altered
ดู [Forensics](../07-Forensics/Forensics-Intro.md) — บาง challenge แก้ height ใน IHDR เพื่อตัดส่วนที่มี flag
