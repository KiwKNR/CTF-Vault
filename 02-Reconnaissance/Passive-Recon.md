...
- เก็บข้อมูล passive ครบแล้วไป [Active-Recon](Active-Recon.md) เพื่อยืนยัน
- ถ้ามีโจทย์ OSINT-only ลึกๆ ดู [OSINT-Techniques](OSINT-Techniques.md)
- พบเว็บแล้วก็ [Enumeration](Enumeration.md)
