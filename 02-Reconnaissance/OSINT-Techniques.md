...
- เครื่องมือ recon โดยรวม [Tools-Setup](../01-Fundamentals/Tools-Setup.md)
- ลึก passive [Passive-Recon](Passive-Recon.md)
- เริ่ม web [03-Web-Exploitation/SQL-Injection](../03-Web-Exploitation/SQL-Injection.md)
