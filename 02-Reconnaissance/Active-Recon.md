...
**Active Recon** = ส่ง packet ไปยังเป้าหมายเพื่อดู response ทำให้ได้ข้อมูลละเอียดกว่า [[Passive-Recon]] แต่ **ทิ้งร่องรอย** (log)
...
ดูใน [[Enumeration]] สำหรับวิธี enum แต่ละ service ละเอียด
...
- หาบริการแล้วไป [[Enumeration]] เพื่อ enum ลึก
- เจอเว็บแล้วไป [[03-Web-Exploitation/SQL-Injection|Web]]
- ก่อนหน้า [[Passive-Recon]]
